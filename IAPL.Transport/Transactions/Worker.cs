 ...
 *  Change Log:
 * 
 *  MNTORRES 09162016 : Added ProcessFiles, Serialize, and SetServerDetails method for serialization
 * 
 */
using System;
...
namespace IAPL.Transport.Transactions
{
    class Worker
    {
        ...
        {
            string xmlFile                     = @"\\WLAP0135\Shared\MessageCodeXMLs\" + sDetails.SourceServerDetails.MessageCode + ".xml";
